...
const capabilities = [
  ...
  { title: "Endpoint & Identity", text: "Work across Entra ID, JAMF, FileVault, local administration, recovery environments, endpoint agents, account access, & device enrollment.", tags: ["Entra ID", "JAMF", "FileVault", "ScreenConnect", "SentinelOne"] },
  { title: "Automation", text: "Build practical internal software when a repeatable operational problem can be solved faster & more reliably with a purpose-built tool.", tags: ["Electron", "JavaScript", "Python", "Workflow Design", "Process Improvement"] },
];
...
const work = [
  ...
  },
  {
    ...
    period: "2026",
    bullets: [
      "Built an Electron-based Warehouse Workflow application that centralizes client access & helps picking & packing teams move between required systems faster.",
      ...
      "Use programming as an operational advantage: identify friction, understand the process, build the smallest useful solution, & improve it with real user feedback.",
    ],
  },
];
...
const projects = [
  ...
  { title: "Workout Tracker + Hercules", type: "AI-Assisted Product", description: "A training tracker with a self-built AI (Hercules) that provides progression coaching, nutrition guidance, & program creation based on publicly available & trusted data.", tech: ["Python", "AI Logic", "Progress Tracking", "Product Design"] },
];
  ...
  return (
    <main>
      ...
      <section className="section container" id="experience">
        <div className="section-heading"><p className="eyebrow">What I bring</p><h2>IT operations & asset management, day-to-day execution & automations.</h2><p>Combining support, infrastructure, inventory, production, & process improvement into practical solutions.</p></div>
      ...
      <section className="section experience-section">
        <div className="container">
          <div className="section-heading narrow"><p className="eyebrow">Experience</p><h2>The work I’ve done & the results.</h2></div>
          <div className="ops-feature">
            <ExperienceMedia />
            <div className="ops-copy"><p className="eyebrow">In practice</p><h3>Device prep, resets, & deployment.</h3><p>Assessment, secure wiping, operating-system recovery, configuration, quality checks, staging, & documentation all have to happen before a device is ready for its next user or client workflow.</p><div className="tags"><span>Secure Wiping</span><span>macOS Recovery</span><span>Device Readiness</span><span>Quality Control</span></div></div>
          </div>
      ...
      <section className="section container" id="projects">
        <div className="section-heading"><p className="eyebrow">Selected projects</p><h2>Projects I built to support operations.</h2><p>My coding background is not separate from my IT work. It helps me diagnose systems, understand workflows, & build solutions that other support professionals may only document.</p></div>
      ...
      <section className="section skills-section" id="skills"><div className="container skills-layout"><div className="section-heading narrow"><p className="eyebrow">Toolkit</p><h2>Technical range built through real use.</h2><p>Comfortable moving between user support, endpoint administration, physical devices, operational workflows, & code.</p></div><div className="skill-list">{skillGroups.map(([title, ...skills]) => <div className="skill-row" key={title}><h3>{title}</h3><div>{skills.map((skill) => <span key={skill}>{skill}</span>)}</div></div>)}</div></div></section>
      ...
      <section className="section container personal-section" id="about">
        ...
        <div className="personal-grid">
          <article className="personal-card personal-card-wide"><h3>My background</h3><div><p>I graduated from Florida State University with a bachelor's degree in Computational Science & a 3.1 GPA. Since then, my professional experience has expanded across IT operations & asset management, AI quality assurance, prompt engineering, & automation-focused software projects.</p><p>I enjoy learning new systems, taking on unfamiliar technology, & contributing to projects & products that people can actually use.</p></div></article>
          <article className="personal-card"><h3>Outside of work</h3><p>I'm a serious gym head & currently train six days a week with a routine that changes monthly. I focus more on strength & endurance than aesthetics.</p><p>I also love EDM & going to raves. KETTAMA, ANOTR, & Underworld are a few of my favorite artists. Traveling is another major interest of mine, & I've visited four countries so far.</p></article>
          <article className="personal-card"><h3>Where I'm headed</h3><p>My long-term goal is to build a career at the intersection of AI, data, & engineering. I'm continuing to strengthen my experience in IT operations, automation, databases, & software so I can move into the part of the technology industry that interests me most.</p></article>
        </div>
      </section>
      ...
      <section className="contact container"><p className="eyebrow">Let's work together! </p><h2>Looking for someone who can support operations & improve it?</h2><p>I'm interested in remote IT support, technical support, junior systems administration, IT operations, & asset management opportunities.</p><div className="hero-actions centered"><a className="button primary" href="https://www.linkedin.com/in/rishard-dukes" target="_blank" rel="noreferrer">Message me on LinkedIn ↗</a><a className="button secondary" href="https://github.com/RishardDukes" target="_blank" rel="noreferrer">Explore GitHub</a></div></section>
